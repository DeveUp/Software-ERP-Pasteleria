...
<!-- ATTRIBUTE -->
<!--           -->
<c:set var="url_project" scope="session" value="../../" />
<c:set var="title_project" scope="session" value="Pastley | Admi" />

<!--        -->
<!-- HEADER -->
<!--        -->
<%@include file="/template/admi/header.jsp"%>

<!--         -->
<!-- SECTION -->
<!--         -->
<div class="pastley-page-structure-center">
	<div class="pastley-container-padding header bg-primary pb-6 ">
		<!--       -->
		<!-- CARDS -->
		<!--       -->
		<div class="row p-jc-between">
...
<!-- FOOTER -->
<!--        -->
<%@include file="/template/admi/footer.jsp"%>